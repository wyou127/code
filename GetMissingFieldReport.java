...
/**
 * Created: 5/27/14 2:59 PM
 * Author: <A HREF="mailto:wyou@walmartlabs.com">Wei You</A>
 */
public class GetMissingFieldReport {
    ...
    public GetMissingFieldReport(Connection connection, String output) {
    ...
    public static void main(String[] args) {
        ...
        try {
            connection = DriverManager.getConnection(
                    ...
                    "STG_GROUPING");
            String path = "/tmp/missingFieldReport";
